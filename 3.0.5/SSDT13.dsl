 ...
 *
 * Disassembly of SSDT13.aml, Sun Apr  7 10:46:16 2024
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000263E (9790)
 *     Revision         0x02
 *     Checksum         0x24
 *     OEM ID           "INTEL "
...
DefinitionBlock ("", "SSDT", 2, "INTEL ", "IgfxSsdt", 0x00003000)
{
    ...
    External (_SB_.GPMV, MethodObj)    // 1 Arguments
    ...
    External (_SB_.PEPD.EMIM, UnknownObj)
    External (_SB_.SGOV, MethodObj)    // 2 Arguments
    External (_SB_.SHPO, MethodObj)    // 2 Arguments
    External (_SB_.SPC0, MethodObj)    // 2 Arguments
    External (_SB_.SPMV, MethodObj)    // 2 Arguments
    ...
    Scope (\_SB.PC00.GFX0)
    {
        ...
        Name (HPM3, Zero)
        Name (HPM4, Zero)
        Method (HPMS, 1, NotSerialized)
        {
            HPMO = ToInteger (Arg0)
            If ((HPMO == Zero))
            {
                PADC = \_SB.GPC0 (0x0014100E)
                PADC &= 0xFFF7FFFF
                \_SB.SPC0 (0x0014100E, PADC)
                If ((HPM4 != Zero))
                {
                    \_SB.SPMV (0x0014100E, HPM4)
                }
            }
            ElseIf ((\_SB.PEPD.EMIM == Zero))
            {
                If ((HPM4 == Zero))
                {
                    HPM4 = \_SB.GPMV (0x0014100E)
                }

                \_SB.SPMV (0x0014100E, Zero)
                \_SB.SHPO (0x0014100E, Zero)
                \_SB.GRXE (0x0014100E, One)
                PADC = \_SB.GPC0 (0x0014100E)
                PADC |= 0x00080000
                PADC &= 0xFFFFFDFF
                \_SB.SPC0 (0x0014100E, PADC)
